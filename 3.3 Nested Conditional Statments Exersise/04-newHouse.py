...
if flowers == 'Roses' and count > 80:
    result = count * flowers_price[flowers] * 0.90        
elif flowers == 'Dahlias' and count > 90:
       result = count * flowers_price[flowers] * 0.85  
elif flowers == 'Tulips' and count > 80:
      result = count * flowers_price[flowers] * 0.85  
elif flowers == 'Narcissus' and count < 120:
      result = count * flowers_price[flowers] * 1.15  
elif flowers == 'Gladiolus' and count < 80:
      result = count * flowers_price[flowers] * 1.20  
else:
     result = count * flowers_price[flowers]
